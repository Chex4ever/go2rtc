...
function normalizeConfig(raw, brandingFromFiles) {
    const cfg = {
        ...
        startFullscreen: !!raw?.startFullscreen,
        wallChromeHidden: !!raw?.wallChromeHidden,
    ...
    return normalizeConfig(
        {
            ...
            startFullscreen: m === 'autostart' || m === 'kiosk',
            wallChromeHidden: m === 'autostart' || m === 'kiosk',
    ...
    return JSON.stringify(
        {
            ...
            wallChromeHidden: cfg.wallChromeHidden,
