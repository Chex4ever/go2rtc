...
**Браузер:** **`http://SERVER:1984/viewer/`**

**Рабочий стол (опционально):** [Electron-клиент](ELECTRON_VIEWER.md) — один раз указать URL сервера (`http://SERVER:1984`), приложение откроет `/viewer/`.
