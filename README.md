...
> **Тесла / go2rtc fork — camera wall:** Custom multi-user wall with layouts, dual streams (main + preview), and Windows desktop client.
>
> | Topic | Doc |
> |-------|-----|
> | Deploy & troubleshoot | **[Sysadmin (EN)](docs/SYSADMIN_EN.md)** · **[RU](docs/SYSADMIN_RU.md)** |
> | Desktop app | **[Electron viewer](docs/ELECTRON_VIEWER.md)** |
> | HTTP API | **[VIEWER_API.md](docs/VIEWER_API.md)** |
> | Releases & CI | **[RELEASE_CI.md](docs/RELEASE_CI.md)** · [Changelog](docs/CHANGELOG_VIEWER.md) |
> | Example config | [viewer.yaml.example](docs/viewer.yaml.example) |
> | Backlog | [REFACTORING_TODO.md](docs/REFACTORING_TODO.md) |
